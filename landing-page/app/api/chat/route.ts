...
const knowledge = {
  mission:
    "Team Relic's mission is to uncover new, undocumented evidence of ancient landscapes in the Amazon's Xingu River headwaters using a novel 'dual wield' approach combining Gemini's visual analysis with targeted GPT-4o API prompts.",
  ...
  anomaly1:
    "Anomaly 1, The Strategic Upland Plateau, is a large, high-elevation plateau (-15.07, -56.13) that likely served as a primary political, economic, and ritual center.",
  anomaly2:
    "Anomaly 2, The Network of Secondary Outposts, is a system of smaller plaza villages (e.g., -14.95, -55.85) that served as strategic outposts and communication hubs.",
  anomaly3:
    "Anomaly 3, The Elevated Travel Corridor, is a vast network of engineered roads and causeways designed for efficient transportation across the landscape.",
  anomaly4:
    "Anomaly 4, The Terrace Settlement, is a site (~ -12.15, -53.40) with evidence of intensive agriculture, indicated by terraces and Amazonian Dark Earth (terra preta).",
  anomaly5:
    "Anomaly 5, The Artificial Shoreline, consists of engineered modifications to lake shores (~ -12.12, -53.42) suggesting advanced water management and aquaculture.",
  ...
  competition:
    "The project is a submission for the 'OpenAI to Z Challenge,' a skills-based competition to discover secrets hidden under the Amazon canopy using AI. Submissions are graded on Evidence Depth, Clarity, Reproducibility, Novelty, and Presentation Craft.",
}
...
function getContextForQuery(query: string): string {
  ...
  if (
    lowerCaseQuery.includes("source") ||
    lowerCaseQuery.includes("citation") ||
...
${specificContext}
    ...
    const response = await openai.chat.completions.create({
      model: "gpt-4o", // Updated to gpt-4o for better compatibility
      stream: true,
